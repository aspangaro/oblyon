...
CKEDITOR.editorConfig = function( config )
{
	...
	config.contentsCss = '/custom/oblyon/css/font.css';
	...
	config.font_names = 'Neuropol/NeuropolRegular, sans-serif;' + 'Puente/PuenteBold, sans-serif;' + 'Century Gothic/Century Gothic, Futura PT, sans-serif;' + 'Cambria/Cambria, Times, serif;' + config.font_names;
