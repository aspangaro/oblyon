 ...
 * @return	void
 */
function print_start_megamenu_entry($idsel,$itemsel,$showmode) {
    if ($showmode) {
        print '<div class="mega-menu">';
        print '<div class="mega-menu-container">';
 ...
 * @return	void
 */
function print_end_megamenu_entry($showmode)
{
    if ($showmode)
    {
        print '</div>';
 ...
 * @return	void
 */
function print_oblyon_megamenu($db, $atarget, $type_user = 0, &$tabMenu, &$menu, $noout=0, $forcemainmenu='', $forceleftmenu='', $moredata=null)
{
    ...
    if (!empty($conf->global->EASYA_VERSION)) {
        $fa = !empty($conf->global->MAIN_FONTAWESOME_ICON_STYLE) ? $conf->global->MAIN_FONTAWESOME_ICON_STYLE : 'fal';
    }
    ...
    print_start_megamenu_entry($idsel, $itemsel, $showmode);

    get_megamenu_home($mainmenu, $newmenu, $type_user, $fa);

    print_end_megamenu_entry($idsel, $itemsel, $showmode);
	...
	if ($showmode) {
        ...
        get_megamenu_thirdparties($mainmenu, $newmenu, $type_user, $fa);
	...
	if ($showmode) {
        ...
        get_megamenu_products($mainmenu, $newmenu, $type_user, $fa);
    ...
    if ($showmode) {
        ...
        get_megamenu_mrp($mainmenu, $newmenu, $type_user, $fa);
	...
	if ($showmode) {
        ...
        get_megamenu_projects($mainmenu, $newmenu, $type_user, $fa);
	...
	if ($showmode) {
        ...
        get_megamenu_commercial($mainmenu, $newmenu, $type_user, $fa);
	...
	if ($showmode) {
        ...
        get_megamenu_billing($mainmenu, $newmenu, $type_user, $fa);
	...
	if ($showmode) {
        ...
        get_megamenu_bank($mainmenu, $newmenu, $type_user, $fa);
	...
	if ($showmode) {
        ...
        get_megamenu_accountancy($mainmenu, $newmenu, $type_user, $fa);
	...
	if ($showmode) {
        ...
        get_megamenu_hrm($mainmenu, $newmenu, $type_user, $fa);
	...
	if ($showmode) {
        ...
        get_megamenu_tickets($mainmenu, $newmenu, $type_user, $fa);
    ...
    if ($showmode) {
        ...
        get_megamenu_tools($mainmenu, $newmenu, $type_user, $fa);
...
function print_start_menu_entry($idsel,$itemsel,$showmode) {
	if ($showmode) {
		print '<li class="mega-menu-dropdown tmenu main-nav__item'.(($itemsel)?' tmenusel is-sel':'').'" id="mainmenutd_'.$idsel.'">';
...
function print_left_oblyon_menu($db, $menu_array_before, $menu_array_after, &$tabMenu, &$menu, $noout = 0, $forcemainmenu = '', $forceleftmenu = '', $moredata = null, $type_user = 0)
{
	...
	if ($mainmenu) {	// If this is empty, loading hard coded menu and loading personalised menu will fail
		// Add personalised menus and modules menus
		$menuArbo = new Menubase($db,'oblyon');
 ...
 * @param	string 		$fa     		Font awesome family
 * @return	void
 */
function get_megamenu_home($mainmenu, &$newmenu, $type_user = 0, $fa = 'fas')
{
    global $user, $conf, $langs;

    $langs->load("users");

    print '<span class="mega-menu_title">' . $langs->trans("Home") . '</span>';

    // Home - dashboard
    //$newmenu->add("/index.php?mainmenu=home&amp;leftmenu=home", $langs->trans("MyDashboard"), 0, 1, '', $mainmenu, 'home');
    $prefix = '<i class="'.$fa.' fa-chart-bar fa-fw paddingright pictofixedwidth"></i> ';
    print '<br><a class="mega-menu_link" href="'.DOL_URL_ROOT.'/index.php?mainmenu=home&amp;leftmenu=home">' . $prefix . $langs->trans("MyDashboard") . '</a>';
    $prefix = '';

    // Setup
    //$newmenu->add("/admin/index.php?mainmenu=home&amp;leftmenu=setup", $langs->trans("Setup"), 0, $user->admin, '', $mainmenu, 'setup');
    $prefix = '<i class="'.$fa.' fa-tools fa-fw paddingright pictofixedwidth"></i> ';
    print '<br><a class="mega-menu_link" href="'.DOL_URL_ROOT.'/admin/index.php?mainmenu=home">' . $prefix . $langs->trans("Setup") . '</a>';
    $prefix = '';
    ...
    if (!empty($user->admin)) {
        ...
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/company.php?mainmenu=home">' . $langs->trans("MenuCompanySetup") . $warnpicto . '</a>';
        ...
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/modules.php?mainmenu=home">' . $langs->trans("Modules") . $warnpicto . '</a>';

        //$newmenu->add("/admin/ihm.php?mainmenu=home", $langs->trans("GUISetup"), 1);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/ihm.php?mainmenu=home">' . $langs->trans("GUISetup") . '</a>';

        // Don't show with oblyon !
        //$newmenu->add("/admin/menus.php?mainmenu=home", $langs->trans("Menus"), 1);
        //print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/menus.php?mainmenu=home">' . $langs->trans("Menus") . '</a>';

        //$newmenu->add("/admin/translation.php?mainmenu=home", $langs->trans("Translation"), 1);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/translation.php?mainmenu=home">' . $langs->trans("Translation") . '</a>';

        //$newmenu->add("/admin/defaultvalues.php?mainmenu=home", $langs->trans("DefaultValues"), 1);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/defaultvalues.php?mainmenu=home">' . $langs->trans("DefaultValues") . '</a>';
        //$newmenu->add("/admin/boxes.php?mainmenu=home", $langs->trans("Boxes"), 1);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/boxes.php?mainmenu=home">' . $langs->trans("Boxes") . '</a>';
        //$newmenu->add("/admin/delais.php?mainmenu=home", $langs->trans("MenuWarnings"), 1);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/delais.php?mainmenu=home">' . $langs->trans("MenuWarnings") . '</a>';
        //$newmenu->add("/admin/security_other.php?mainmenu=home", $langs->trans("Security"), 1);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/security_other.php?mainmenu=home">' . $langs->trans("Security") . '</a>';
        //$newmenu->add("/admin/limits.php?mainmenu=home", $langs->trans("MenuLimits"), 1);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/limits.php?mainmenu=home">' . $langs->trans("MenuLimits") . '</a>';
        //$newmenu->add("/admin/pdf.php?mainmenu=home", $langs->trans("PDF"), 1);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/pdf.php?mainmenu=home">' . $langs->trans("PDF") . '</a>';
        ...
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/mails.php?mainmenu=home">' . $langs->trans("Emails") . $warnpicto . '</a>';
        //$newmenu->add("/admin/sms.php?mainmenu=home", $langs->trans("SMS"), 1);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/sms.php?mainmenu=home">' . $langs->trans("SMS") . '</a>';
        //$newmenu->add("/admin/dict.php?mainmenu=home", $langs->trans("Dictionary"), 1);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/dict.php?mainmenu=home">' . $langs->trans("Dictionary") . '</a>';
        //$newmenu->add("/admin/const.php?mainmenu=home", $langs->trans("OtherSetup"), 1);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/admin/const.php?mainmenu=home">' . $langs->trans("OtherSetup") . '</a>';
 ...
 * @return	void
 */
function get_megamenu_thirdparties($mainmenu, &$newmenu, $type_user = 0, $fa = 'fas')
{
    global $user, $conf, $langs;
    ...
    if (!empty($conf->societe->enabled)) {
        print '<span class="mega-menu_title">' . $langs->trans("ThirdParty") . '</span>';
        ...
        if ($user->rights->societe->lire) {
            $prefix = '<i class="' . $fa . ' fa-building fa-fw paddingright pictofixedwidth"></i> ';
            print '<br><a class="mega-menu_link" href="' . DOL_URL_ROOT . '/societe/index.php?mainmenu=companies">' . $prefix . $langs->trans("ThirdParty") . '</a>';
        }

        if ($user->rights->societe->creer) {
            //$newmenu->add("/societe/card.php?action=create", $langs->trans("MenuNewThirdParty"), 1);
            $urlcreate = "/societe/card.php?action=create";
            $langcreate = $langs->trans("MenuNewThirdParty");

            if (!$conf->use_javascript_ajax) {
                //$newmenu->add("/societe/card.php?action=create&amp;private=1", $langs->trans("MenuNewPrivateIndividual"), 1);
                $urlcreate = "/societe/card.php?action=create&amp;private=1";
                $langcreate = $langs->trans("MenuNewPrivateIndividual");
            }
            print '<a class="mega-menu_link_create" href="'.DOL_URL_ROOT.$urlcreate.'"><i class="' . $fa . ' fa-plus-circle fa-fw paddingright pictofixedwidth" title="'.$langs->trans($langcreate).'"></i></a>';
        }
    }

    if ($user->rights->societe->lire) {
        // $newmenu->add("/societe/list.php?leftmenu=thirdparties", $langs->trans("List"), 1);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/societe/list.php">' . $langs->trans("List") . '</a>';
        ...
        if (!empty($conf->societe->enabled) && empty($conf->global->SOCIETE_DISABLE_PROSPECTS)) {
            ...
            print '<br><a class="mega-menu_link_level3" href="'.DOL_URL_ROOT.'/societe/list.php?type=p">' . $langs->trans("ListProspectsShort") . '</a>';
            ...
            if ($user->rights->societe->creer) print '<a class="mega-menu_link_create" href="'.DOL_URL_ROOT.'/societe/card.php?action=create&amp;type=p"><i class="' . $fa . ' fa-plus-circle fa-fw paddingright pictofixedwidth" title="'.$langs->trans('MenuNewProspect').'"></i></a>';
        }
        ...
        if (!empty($conf->societe->enabled) && empty($conf->global->SOCIETE_DISABLE_CUSTOMERS)) {
            ...
            print '<br><a class="mega-menu_link_level3" href="'.DOL_URL_ROOT.'/societe/list.php?type=c">' . $langs->trans("ListCustomersShort") . '</a>';
            ...
            if ($user->rights->societe->creer) print '<a class="mega-menu_link_create" href="'.DOL_URL_ROOT.'/societe/card.php?action=create&amp;type=c"><i class="' . $fa . ' fa-plus-circle fa-fw paddingright pictofixedwidth" title="'.$langs->trans('MenuNewCustomer').'"></i></a>';
        }
        ...
        if (!empty($conf->societe->enabled) && (((!empty($conf->fournisseur->enabled) && empty($conf->global->MAIN_USE_NEW_SUPPLIERMOD)) || !empty($conf->supplier_order->enabled) || !empty($conf->supplier_invoice->enabled)) || !empty($conf->supplier_proposal->enabled))) {
            ...
            print '<br><a class="mega-menu_link_level3" href="'.DOL_URL_ROOT.'/societe/list.php?type=f">' . $langs->trans("ListSuppliersShort") . '</a>';
            ...
            if ($user->rights->societe->creer) print '<a class="mega-menu_link_create" href="'.DOL_URL_ROOT.'/societe/card.php?action=create&amp;type=f"><i class="' . $fa . ' fa-plus-circle fa-fw paddingright pictofixedwidth" title="'.$langs->trans('MenuNewSupplier').'"></i></a>';
        }
        ...
        if (!empty($conf->categorie->enabled)) {
            ...
            if (empty($conf->global->SOCIETE_DISABLE_PROSPECTS) || empty($conf->global->SOCIETE_DISABLE_CUSTOMERS)) {
                ...
                if ($user->rights->categorie->lire) print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/categories/index.php?type=2">' . $langs->trans($menutoshow) . '</a>';
            }
            ...
            if ((!empty($conf->fournisseur->enabled) && empty($conf->global->MAIN_USE_NEW_SUPPLIERMOD)) || !empty($conf->supplier_order->enabled) || !empty($conf->supplier_invoice->enabled)) {
                ...
                if ($user->rights->categorie->lire) print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/categories/index.php?type=1">' . $langs->trans("SuppliersCategoriesShort") . '</a>';
            }
        }
    }
    ...
    if ($user->rights->societe->contact->lire) {
        ...
        $prefix = '<i class="' . $fa . ' fa-address-book fa-fw paddingright pictofixedwidth"></i> ';
        print '<br><a class="mega-menu_link" href="' . DOL_URL_ROOT . '/societe/index.php?mainmenu=companies">' . $prefix . (! empty($conf->global->SOCIETE_ADDRESSES_MANAGEMENT) ? $langs->trans("Contacts") : $langs->trans("ContactsAddresses")) . '</a>';
        ...
        if ($user->rights->societe->contact->creer) {
            ...
            print '<a class="mega-menu_link_create" href="' . DOL_URL_ROOT . '/contact/card.php?action=create"><i class="' . $fa . ' fa-plus-circle fa-fw paddingright pictofixedwidth" title="' . (!empty($conf->global->SOCIETE_ADDRESSES_MANAGEMENT) ? $langs->trans("NewContact") : $langs->trans("NewContactAddress")) . '"></i></a>';
        }
        //$newmenu->add("/contact/list.php?leftmenu=contacts", $langs->trans("List"), 1, $user->rights->societe->contact->lire);
        print '<br><a class="mega-menu_link_level2" href="'.DOL_URL_ROOT.'/contact/list.php">' . $langs->trans("List") . '</a>';
        if (empty($conf->global->SOCIETE_DISABLE_PROSPECTS)) {
            //$newmenu->add("/contact/list.php?leftmenu=contacts&type=p", $langs->trans("Prospects"), 2, $user->rights->societe->contact->lire);
            print '<br><a class="mega-menu_link_level3" href="'.DOL_URL_ROOT.'/contact/list.php?type=p">' . $langs->trans("Prospects") . '</a>';
        }
        if (empty($conf->global->SOCIETE_DISABLE_CUSTOMERS)) {
            //$newmenu->add("/contact/list.php?leftmenu=contacts&type=c", $langs->trans("Customers"), 2, $user->rights->societe->contact->lire);
            print '<br><a class="mega-menu_link_level3" href="'.DOL_URL_ROOT.'/contact/list.php?type=c">' . $langs->trans("Customers") . '</a>';
        }
        if ((!empty($conf->fournisseur->enabled) && empty($conf->global->MAIN_USE_NEW_SUPPLIERMOD)) || !empty($conf->supplier_order->enabled) || !empty($conf->supplier_invoice->enabled)) {
            //$newmenu->add("/contact/list.php?leftmenu=contacts&type=f", $langs->trans("Suppliers"), 2, $user->rights->societe->contact->lire);
            print '<br><a class="mega-menu_link_level3" href="'.DOL_URL_ROOT.'/contact/list.php?type=f">' . $langs->trans("Suppliers") . '</a>';
        }
        //$newmenu->add("/contact/list.php?leftmenu=contacts&type=o", $langs->trans("ContactOthers"), 2, $user->rights->societe->contact->lire);
        print '<br><a class="mega-menu_link_level3" href="'.DOL_URL_ROOT.'/contact/list.php?type=o">' . $langs->trans("ContactOthers") . '</a>';
    }
    ...
    if (!empty($conf->categorie->enabled)) {
        ...
        if ($user->rights->categorie->lire) print '<br><a class="mega-menu_link_level3" href="'.DOL_URL_ROOT.'/categories/index.php?leftmenu=catcontact&amp;type=4">' . $langs->trans("ContactCategoriesShort") . '</a>';
    }
}

/**
 * Get megamenu Products
 *
 * @param	string		$mainmenu		Main menu
 * @param	Menu 		$newmenu		Object Menu to return back list of menu entries
 * @param	int 		$type_user		Type of user
 ...
 * @return	void
 */
function get_megamenu_products($mainmenu, &$newmenu, $type_user = 0, $fa = 'fas')
{
    global $user, $conf, $langs;
...
/**
 * Get megamenu Commercial (propal, commande, supplier_proposal, supplier_order, contrat, ficheinter)
 *
 * @param	string		$mainmenu		Main menu
 * @param	Menu 		$newmenu		Object Menu to return back list of menu entries
 * @param	int 		$type_user		Type of user
 ...
 * @return	void
 */
function get_megamenu_commercial($mainmenu, &$newmenu, $type_user = 0, $fa = 'fas')
{
    global $user, $conf, $langs;
 ...
 * @return	void
 */
function get_megamenu_projects($mainmenu, &$newmenu, $type_user = 0, $fa = 'fas')
{
    global $user, $conf, $langs;
 ...
 * @return	void
 */
function get_megamenu_bank($mainmenu, &$newmenu, $type_user = 0, $fa = 'fas')
{
    global $user, $conf, $langs;
 ...
 * @return	void
 */
function get_megamenu_hrm($mainmenu, &$newmenu, $type_user = 0, $fa = 'fas')
{
    global $user, $conf, $langs;
 ...
 * @return	void
 */
function get_megamenu_tickets($mainmenu, &$newmenu, $type_user = 0, $fa = 'fas')
{
    global $user, $conf, $langs;
    ...
    if (!empty($conf->societe->enabled)) {
        ...
        if (!empty($conf->propal->enabled)) {
            ...
            if ($user->rights->propale->lire) {
                //$newmenu->add("/comm/propal/index.php?leftmenu=propals", $langs->trans("Proposals"), 0, $user->rights->propale->lire, '', $mainmenu, 'propals', 100, '', '', '', img_picto('', 'propal', 'class="paddingright pictofixedwidth"'));
                $prefix = '<i class="' . $fa . ' fa-file-signature fa-fw paddingright pictofixedwidth"></i> ';
                print '<br><a class="mega-menu_link" href="' . DOL_URL_ROOT . '/comm/propal/index.php?mainmenu=commercial">' . $prefix . $langs->trans("Proposals") . '</a>';

                //$newmenu->add("/comm/propal/card.php?action=create&amp;leftmenu=propals", $langs->trans("NewPropal"), 1, $user->rights->propale->creer);
                print '<a class="mega-menu_link_create" href="' . DOL_URL_ROOT . '/comm/propal/card.php?action=create"><i class="' . $fa . ' fa-plus-circle fa-fw paddingright pictofixedwidth" title="' . $langs->trans("NewPropal") . '"></i></a>';

                //$newmenu->add("/comm/propal/list.php?leftmenu=propals", $langs->trans("List"), 1, $user->rights->propale->lire);
                print '<br><a class="mega-menu_link_level2" href="' . DOL_URL_ROOT . '/comm/propal/list.php">' . $langs->trans("List") . '</a>';

                //$newmenu->add("/comm/propal/list.php?leftmenu=propals&search_status=0", $langs->trans("PropalsDraft"), 2, $user->rights->propale->lire);
                print '<br><a class="mega-menu_link_level3" href="' . DOL_URL_ROOT . '/comm/propal/list.php?search_status=0">' . $langs->trans("PropalsDraft") . '</a>';
                //$newmenu->add("/comm/propal/list.php?leftmenu=propals&search_status=1", $langs->trans("PropalsOpened"), 2, $user->rights->propale->lire);
                print '<br><a class="mega-menu_link_level3" href="' . DOL_URL_ROOT . '/comm/propal/list.php?search_status=1">' . $langs->trans("PropalsOpened") . '</a>';
                //$newmenu->add("/comm/propal/list.php?leftmenu=propals&search_status=2", $langs->trans("PropalStatusSigned"), 2, $user->rights->propale->lire);
                print '<br><a class="mega-menu_link_level3" href="' . DOL_URL_ROOT . '/comm/propal/list.php?search_status=2">' . $langs->trans("PropalStatusSigned") . '</a>';
                //$newmenu->add("/comm/propal/list.php?leftmenu=propals&search_status=3", $langs->trans("PropalStatusNotSigned"), 2, $user->rights->propale->lire);
                print '<br><a class="mega-menu_link_level3" href="' . DOL_URL_ROOT . '/comm/propal/list.php?search_status=3">' . $langs->trans("PropalStatusNotSigned") . '</a>';
                //$newmenu->add("/comm/propal/list.php?leftmenu=propals&search_status=4", $langs->trans("PropalStatusBilled"), 2, $user->rights->propale->lire);
                print '<br><a class="mega-menu_link_level3" href="' . DOL_URL_ROOT . '/comm/propal/list.php?search_status=4">' . $langs->trans("PropalStatusBilled") . '</a>';

                //$newmenu->add("/comm/propal/stats/index.php?leftmenu=propals", $langs->trans("Statistics"), 1, $user->rights->propale->lire);
                print '<br><a class="mega-menu_link_level2" href="' . DOL_URL_ROOT . '/comm/propal/stats/index.php">' . $langs->trans("Statistics") . '</a>';
            }
        }
    }
}
 ...
 * @return	void
 */
function get_megamenu_members($mainmenu, &$newmenu, $type_user = 0, $fa = 'fas')
{
    global $user, $conf, $langs;
