...
$dashboard_colors = array (
	...
	'OBLYON_INFOXBOX_ACTION_COLOR',				// #AB4DA1 AGENDA
	'OBLYON_INFOXBOX_PROJECT_COLOR',			// #6C6A98
	'OBLYON_INFOXBOX_CUSTOMER_PROPAL_COLOR',	// #49CC29 PROPAL
	'OBLYON_INFOXBOX_CUSTOMER_ORDER_COLOR',	 	// #49CC29 COMMANDE
	'OBLYON_INFOXBOX_CUSTOMER_INVOICE_COLOR',   // #49CC29 FACTURE
	...
	'OBLYON_INFOXBOX_CONTRAT_COLOR',			// #8C5545
	'OBLYON_INFOXBOX_BANK_COLOR',				// #3333CC
	'OBLYON_INFOXBOX_ADHERENT_COLOR',			// #79631C
	'OBLYON_INFOXBOX_EXPENSEREPORT_COLOR',		// #D1D12A
	'OBLYON_INFOXBOX_HOLIDAY_COLOR',			// #E0A01F
	'OBLYON_INFOXBOX_TICKET_COLOR',             // #C93E28
);
...
print ajax_constantonoff("MAIN_DISABLE_GLOBAL_WORKBOARD", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
print '</td>';
print '</tr>';

// Activation des statistiques globales
print '<tr class="oddeven"><td>' . $langs->trans('DisableGlobalBoxStats') . '</td><td>';
print ajax_constantonoff("MAIN_DISABLE_GLOBAL_BOXSTATS", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
print '</td>';
print '</tr>';

// Invertion des couleurs de fond et d'icone
 print '<tr class="oddeven"><td>' . $langs->trans('InfoboxColorOnBackground') . '</td><td>';
print ajax_constantonoff("THEME_INFOBOX_COLOR_ON_BACKGROUND", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
print '</td>';
print '</tr>';
...
if ((float) $conf->global->EASYA_VERSION >= 2022.5 || (float) DOL_VERSION >= 15.0) {
	if (empty($conf->global->MAIN_DISABLE_GLOBAL_WORKBOARD)) {
		...
		print ajax_constantonoff("MAIN_DISABLE_METEO", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
		print '</td>';
		print '</tr>';

		// Block agenda
		print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockAgenda') . '</td><td>';
		print ajax_constantonoff("MAIN_DISABLE_BLOCK_AGENDA", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
		print '</td>';
		print '</tr>';

		// Block projet
		print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockProject') . '</td><td>';
		print ajax_constantonoff("MAIN_DISABLE_BLOCK_PROJECT", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
		print '</td>';
		print '</tr>';

		// Block customer
		print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockCustomer') . '</td><td>';
		print ajax_constantonoff("MAIN_DISABLE_BLOCK_CUSTOMER", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
		print '</td>';
		print '</tr>';

		// Block supplier
		print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockSupplier') . '</td><td>';
		print ajax_constantonoff("MAIN_DISABLE_BLOCK_SUPPLIER", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
		print '</td>';
		print '</tr>';

		// Block contract
		print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockContract') . '</td><td>';
		print ajax_constantonoff("MAIN_DISABLE_BLOCK_CONTRACT", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
		print '</td>';
		print '</tr>';

		// Block ticket
		print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockTicket') . '</td><td>';
		print ajax_constantonoff("MAIN_DISABLE_BLOCK_TICKET", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
		print '</td>';
		print '</tr>';

		// Block bank
		print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockBank') . '</td><td>';
		print ajax_constantonoff("MAIN_DISABLE_BLOCK_BANK", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
		print '</td>';
		print '</tr>';

		// Block adherent
		print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockAdherent') . '</td><td>';
		print ajax_constantonoff("MAIN_DISABLE_BLOCK_ADHERENT", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
		print '</td>';
		print '</tr>';

		// Block expense report
		print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockExpenseReport') . '</td><td>';
		print ajax_constantonoff("MAIN_DISABLE_BLOCK_EXPENSEREPORT", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
		print '</td>';
		print '</tr>';

		// Block holiday
		print '<tr class="oddeven"><td>' . $langs->trans('DashboardDisableBlockHoliday') . '</td><td>';
		print ajax_constantonoff("MAIN_DISABLE_BLOCK_HOLIDAY", array(), $conf->entity, 0, 0, 1, 0, 0, 0, '', 'dashboard');
		print '</td>';
		print '</tr>';
