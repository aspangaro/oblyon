...
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_TOPMENU_TXT_ACTIVE',			'__ENTITY__', '#F3F2F4',			'chaine',	'0',	'Oblyon text top menu active');
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_TOPMENU_TXT_HOVER',			'__ENTITY__', '#F3F2F4',			'chaine',	'0',	'Oblyon text top menu hover');
-- Color - left
...
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_LEFTMENU_TXT_ACTIVE',		'__ENTITY__', '#F3F2F4',			'chaine',	'0',	'Oblyon foreground leftmenu hover color');
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_LEFTMENU_TXT_HOVER',			'__ENTITY__', '#F3F2F4',			'chaine',	'0',	'Oblyon foreground leftmenu hover color');
-- Color - button
...
-- Color - message
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_INFO_BORDER',				'__ENTITY__', '#87CFD2',			'chaine',	'0',	'Oblyon border info notification');
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_INFO_BCKGRD',				'__ENTITY__', '#EFF8FC',			'chaine',	'0',	'Oblyon background info notification');
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_INFO_TEXT',					'__ENTITY__', '#87CFD2',			'chaine',	'0',	'Oblyon text info notification');
...
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_WARNING_TEXT',				'__ENTITY__', '#F2CF87',			'chaine',	'0',	'Oblyon text warning message');
...
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_ERROR_TEXT',					'__ENTITY__', '#F3F2F4',			'chaine',	'0',	'Oblyon text error message');
...
-- Color - options
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_MAIN',						'__ENTITY__', '#263C5C',			'chaine',	'0',	'Oblyon maincolor');
...
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_LOGO_BCKGRD',				'__ENTITY__', '#092D5C',			'chaine',	'0',	'Oblyon background logo color');
...
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_BTITLE',						'__ENTITY__', '#E9EAED',			'chaine',	'0',	'Oblyon background title');
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_FTITLE',						'__ENTITY__', '#28283C',			'chaine',	'0',	'Oblyon text title');
...
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('OBLYON_COLOR_INPUT_BCKGRD',				'__ENTITY__', '#DEDEDE',			'chaine',	'0',	'Oblyon background imput color');
...
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('THEME_ELDY_BACKTITLE1',					'__ENTITY__', '#FFFFFF',			'chaine',	'0',	'Oblyon module');
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('THEME_ELDY_BACKTABACTIVE',				'__ENTITY__', '#EAEAEA',			'chaine',	'0',	'Oblyon module');
...
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('THEME_ELDY_TEXTTITLENOTAB',				'__ENTITY__', '#28283C',			'chaine',	'0',	'Oblyon module');
...
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('THEME_ELDY_TEXT',							'__ENTITY__', '#444444',			'chaine',	'0',	'Oblyon module');
INSERT INTO llx_const (name, entity, value, type, visible, note) VALUES ('THEME_ELDY_TEXTLINK',						'__ENTITY__', '#0A1464',			'chaine',	'0',	'Oblyon module');
